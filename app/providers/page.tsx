...
const allProviders = dummyProviders;
...
export default function ProvidersPage() {
  ...
  // Synchronize URL cat parameter with selectedCategories
  useEffect(() => {
    ...
    if (catParam) {
      const matched = categories.filter((c) => {
        ...
        if (catParam === "tutoring") return c.toLowerCase().includes("academic") || c.toLowerCase().includes("tutor");
        if (catParam === "food") return c.toLowerCase().includes("cook") || c.toLowerCase().includes("food");
        if (catParam === "tech") return c.toLowerCase().includes("digital") || c.toLowerCase().includes("tech");
        if (catParam === "repairs") return c.toLowerCase().includes("repair") || c.toLowerCase().includes("home");
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Find vetted and reliable service providers near you
              </p>
            </div>
