...
export default function CustomerRegisterPage() {
  ...
  return (
    <AuthLayout 
      ...
      subtitle="Join Haven to find and hire trusted service professionals."
    >
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="pt-2">
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              className={`mt-1 rounded-md border-slate-300 data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600 ${
          ...
          {errors.terms && (
            <p className="text-red-500 text-xs font-medium mt-1 ml-7">{errors.terms}</p>
          )}
        </div>
        ...
        <Button
          ...
          className="w-full h-14 rounded-xl text-lg font-semibold bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all active:scale-[0.98] mt-6"
        >
          {isSubmitting ? (
            <>
